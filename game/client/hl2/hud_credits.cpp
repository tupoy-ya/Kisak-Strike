...
public:
	...
	bool MsgFunc_CreditsMsg( const CHLUsrMsg_CreditsMsg &msg );
	bool MsgFunc_LogoTimeMsg( const CHLUsrMsg_LogoTimeMsg &msg );
...
bool CHudCredits::MsgFunc_CreditsMsg( const CHLUsrMsg_CreditsMsg &msg )
{
	m_iCreditsType = 0; // msg.ReadByte();
...
bool CHudCredits::MsgFunc_LogoTimeMsg( const CHLUsrMsg_LogoTimeMsg &msg )
{
	m_iCreditsType = CREDITS_LOGO;
	PrepareLogo( 5.0f /* msg.ReadFloat()*/ );
	return true;
}
