...
public:
	...
	virtual	void	StandardBlendingRules( Vector pos[], BoneQuaternionAligned q[], float currentTime, int boneMask );
...
void  C_NPC_Hydra::StandardBlendingRules( Vector pos[], BoneQuaternionAligned q[], float currentTime, int boneMask )
{
