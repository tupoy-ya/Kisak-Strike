...
static C_HLRootPanel *g_pCSRootPanel[ MAX_SPLITSCREEN_PLAYERS ];
static C_HLRootPanel *g_pFullscreenRootPanel;
...
void VGUI_CreateClientDLLRootPanel( void )
{
	for ( int i = 0 ; i < MAX_SPLITSCREEN_PLAYERS; ++i )
	{
		g_pCSRootPanel[ i ] = new C_HLRootPanel( enginevgui->GetPanel( PANEL_CLIENTDLL ), i );
	}

	g_pFullscreenRootPanel = new C_HLRootPanel( enginevgui->GetPanel( PANEL_CLIENTDLL ), 0, "Fullscreen Root Panel" );
